...
The quick closed-loop check still reached 0% real success: 1-step replanning averaged 27.70px and 4-step commitment averaged 28.04px. Both are worse than executing the best structured detour open-loop (21.90px in the same check), confirming that the current replanner rebuilds away useful route state.
